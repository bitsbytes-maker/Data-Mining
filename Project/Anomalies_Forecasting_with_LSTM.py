...
get_ipython().system('jupyter nbconvert --to python Anomalies_Forecasting_with_LSTM copy.ipynb')
...
plt.plot(new_y_test, label='Actual Anomoulous melting area')
plt.plot(test_predictions, label='Predicted Anomoulous melting area')
plt.xlabel('Day')
plt.ylabel('Anomoulous melting area')
plt.legend()
plt.show()
